...
import { SVC_ENUM_APP_USER_ROLE, SVC_ENUM_CRITICALITY_TYPE, SVC_ENUM_ROOM_TYPE, SVC_ENUM_ACTIVITY_TYPE, SVC_ENUM_PERIODICITY } from '$lib/serviceRoutes'
...
export const load: PageLoad = async ({ fetch }) => {
    ...
    let periodicity = await fetch(SVC_ENUM_PERIODICITY.LIST()).then(response => {
        return response.json();
    });
	...
	return {
		...
		periodicity: periodicity.enum_values,
